...
The Java Pathfinder (JPF) team will apply again as a mentor organization for the [Google Summer of Code](https://summerofcode.withgoogle.com/.md) (GSoC) program this year 2024.
...
<!-- *Note that JPF has not yet been accepted for GSoC 2024 and that our [project ideas](https://github.com/javapathfinder/jpf-core/wiki/gsoc-2024-project-ideas.md) are still being extended and refined.* -->
...
The official timeline of GSoC 2024 can be found here: [GSoC 2024 Timeline](https://developers.google.com/open-source/gsoc/timeline.md)

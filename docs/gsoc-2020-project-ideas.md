...
* [Support Java 11 (bootstrap methods) for jpf-core](#support-java-11-bootstrap-methods-for-jpf-core.md) <Cyrille>

* [Support Java 12 (private API dependencies) for jpf-core](#support-for-java-12-private-api-dependencies-for-jpf-core.md) <Cyrille>
...
* [Improving String analysis in SPF](#improving-string-analysis-in-spf.md) <Yannic><Corina>

* [Refactoring SPF constraint library](#refactoring-spf-constraint-library.md) <Elena>

* [Symbolic PathFinder for Neural Network Analysis](#symbolic-pathfinder-for-neural-network-analysis.md) <Corina><Sarfraz><Yannic>
...
**Expected outcomes:** Clear reduction in memory usage of SPF when we run benchmarks. The idea of hash-consing is being adapted from the veritesting paper by [Avgerinos et al.](https://dl.acm.org/doi/abs/10.1145/2568225.2568293?casa_token=wgy5x3esr5aaaaaa:50nh1dsj_yrg1pyv4zngz8a4rlfyj49eetxfh7ohuqmwr_4vjjs9u5h5_assjt54fvniubec0mydu2m.md)
...
**Difficulty:** Hard  
**Required skills:** Knowledge of path-merging in symbolic execution; examples include [dynamic state merging](https://dslab.epfl.ch/pubs/statemerging.pdf.md) and/or [veritesting](https://dl.acm.org/doi/abs/10.1145/2568225.2568293?casa_token=wgy5x3esr5aaaaaa:50nh1dsj_yrg1pyv4zngz8a4rlfyj49eetxfh7ohuqmwr_4vjjs9u5h5_assjt54fvniubec0mydu2m.md)  
**Preferred skills:** Knowledge of SPF's internals when it comes to its execution of conditional branches; knowledge of [Java Ranger](https://github.com/vaibhavbsharma/java-ranger.md) would be further beneficial  
